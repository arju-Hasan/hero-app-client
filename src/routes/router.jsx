    ...
    children: [
      {
        path: "",
        element: <Home></Home>,
        loader: () => fetch("https://hero-apps-pagination-starter-server-two.vercel.app/apps"),
      },
      {
        path: "/apps",
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(`https://hero-apps-pagination-starter-server-two.vercel.app/apps/${params.id}`),
      },
      {
        path: "/installations",
